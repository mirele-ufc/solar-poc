import svgPaths from "./svg-jjr9q1cu6j";
...
function Modulo() {
  return (
    <div className="h-[36px] relative shrink-0 w-[304px]" data-name="módulo 01">
      <p className="absolute font-['Figtree:Bold',sans-serif] font-bold leading-[0] left-0 text-[0px] text-[24px] text-black top-0 whitespace-nowrap">
        <span className="leading-[36px]">Módulo 01</span>
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-10px] p-[10px] top-[-10px]">
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[20px] text-black whitespace-nowrap">Aula 01</p>
    </div>
  );
}
...
function Aula() {
  return (
    <div className="h-[36px] relative shrink-0 w-[304px]" data-name="aula 01">
      <Frame1 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-10px] p-[10px] top-[-10px]">
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[20px] text-black whitespace-nowrap">Aula 02</p>
    </div>
  );
}
...
function Aula1() {
  return (
    <div className="h-[36px] relative shrink-0 w-[304px]" data-name="aula 02">
      <Frame2 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-10px] p-[10px] top-[-10px]">
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[20px] text-black whitespace-nowrap">Aula 03</p>
    </div>
  );
}
...
function Aula2() {
  return (
    <div className="h-[36px] relative shrink-0 w-[304px]" data-name="aula 03">
      <Frame3 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[-10px] p-[10px] top-[-10px]">
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[20px] text-black whitespace-nowrap">Prova 01</p>
    </div>
  );
}
...
function Prova() {
  return (
    <div className="h-[36px] relative shrink-0 w-[304px]" data-name="prova">
      <Frame4 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#c5d6ff] content-stretch flex flex-col gap-[12px] h-[487px] items-center left-1/2 pb-[18px] pt-[22px] px-[21px] rounded-[12px] top-[150px] w-[360px]">
      ...
      <Modulo />
      <Aula />
      <div className="h-0 relative shrink-0 w-[299px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 299 1">
            <line id="Line 5" stroke="var(--stroke-0, #759BFB)" x2="299" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Aula1 />
