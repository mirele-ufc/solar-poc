import svgPaths from "./svg-kg29qcptmf";
...
function Frame49Botao({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function AdicaoDeModulo() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[21px] items-center pb-[30px] pt-[90px] px-[20px] relative size-full" data-name="Adição de módulo">
      <div className="content-stretch flex flex-col h-[681px] items-start justify-between relative shrink-0">
        <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0">
          ...
          <div className="relative shrink-0 w-[362px]">
            <div className="content-stretch flex flex-col gap-[16px] items-center justify-center overflow-clip p-[16px] relative rounded-[inherit] w-full">
              <p className="font-['Figtree:Bold',sans-serif] font-bold h-[26px] leading-[30px] relative shrink-0 text-[#021b59] text-[20px] w-[327px]">Módulo 02</p>
              <div className="bg-[#efbbdc] content-stretch flex h-[60px] items-center justify-between px-[20px] relative shrink-0 w-[327px]">
                <p className="flex-[1_0_0] font-['Figtree:Medium',sans-serif] font-medium h-[31px] leading-[30px] min-h-px min-w-px relative text-[20px] text-black">Adicionar aula</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border border-black border-solid inset-0 pointer-events-none" />
          </div>
        </div>
        <div className="content-stretch cursor-pointer flex flex-col gap-[20px] items-center relative shrink-0 w-full">
          <Frame49Botao>
