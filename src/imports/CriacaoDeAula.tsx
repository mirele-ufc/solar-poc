import svgPaths from "./svg-ydubfk4g0j";
...
function Frame47Botao({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function CriacaoDeAula() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-center pb-[30px] pt-[90px] px-[20px] relative size-full" data-name="Criação de Aula">
      <div className="content-stretch flex flex-col h-[681px] items-start justify-between relative shrink-0 w-[359px]">
