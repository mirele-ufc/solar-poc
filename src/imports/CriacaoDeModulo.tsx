import svgPaths from "./svg-d770jwpopc";
...
function Frame43Botao({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function CriacaoDeModulo() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-center pb-[30px] pt-[90px] px-[20px] relative size-full" data-name="Criação de Módulo">
      <div className="content-stretch flex flex-col h-[681px] items-center justify-between relative shrink-0">
