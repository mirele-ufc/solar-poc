import svgPaths from "./svg-23i29bykys";
...
function Wrapper({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 w-[362px]">
      <div className="content-stretch flex flex-col gap-[16px] items-center overflow-clip pt-[16px] px-[16px] relative rounded-[inherit] w-full">{children}</div>
...
function BotaoText({ text }: BotaoTextProps) {
  return (
    <button className="bg-[#ffeac4] cursor-pointer h-[60px] relative rounded-[26px] shrink-0 w-[362px]">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center py-[9px] relative size-full">
...
export default function ModuloComProva() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-center pt-[90px] relative size-full" data-name="Modulo com prova">
      <Wrapper>
        <p className="font-['Figtree:Bold',sans-serif] font-bold leading-[30px] min-w-full relative shrink-0 text-[#021b59] text-[20px] w-[min-content]">Módulo 01</p>
        <Text text="Aula 01" />
        <Text text="Aula 02" />
        <Text1 text="Prova 01" />
      ...
      <Wrapper>
        <p className="font-['Figtree:Bold',sans-serif] font-bold leading-[30px] min-w-full relative shrink-0 text-[#021b59] text-[20px] w-[min-content]">Módulo 02</p>
        <Text1 text="Aula 01" />
        <Text1 text="Aula 02" />
        <BotaoText text="Adicionar prova" />
      </Wrapper>
