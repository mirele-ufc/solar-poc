import svgPaths from "./svg-z1pggbvwxx";
  ...
  return (
    <div className="bg-white content-stretch flex flex-col gap-[30px] items-start pt-[90px] px-[20px] relative size-full" data-name="Cursos">
      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
        <p className="font-['Figtree:Bold',sans-serif] font-bold h-[37px] leading-[36px] relative shrink-0 text-[#021b59] text-[24px] w-full">Acompanhe os cursos</p>
        <button className="bg-[#ffeac4] cursor-pointer relative rounded-[26px] shrink-0 w-full" data-name="Botão">
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex items-center justify-center py-[9px] relative w-full">
              <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[#333] text-[20px] text-center whitespace-nowrap">Criar curso</p>
            </div>
          </div>
        </button>
      </div>
      <div className="content-stretch flex flex-col gap-[21px] items-start relative shrink-0 w-[382px]">
        <p className="font-['Figtree:Bold',sans-serif] font-bold leading-[36px] relative shrink-0 text-[#021b59] text-[24px] w-full">Cursos ativos</p>
        <div className="content-stretch flex gap-[10px] items-start overflow-x-auto overflow-y-clip relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0">
            <Image />
            <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[20px] text-black text-center w-[217px]">Matemática básica</p>
          </div>
        </div>
      </div>
      <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[382px]">
        <p className="font-['Figtree:Bold',sans-serif] font-bold leading-[36px] relative shrink-0 text-[#021b59] text-[24px] w-full">Cursos arquivados</p>
