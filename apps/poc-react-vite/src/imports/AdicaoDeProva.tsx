import svgPaths from "./svg-q2d7cwmfy6";
...
export default function AdicaoDeProva() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] items-center pb-[30px] pt-[70px] px-[20px] relative size-full" data-name="Adição de prova">
      ...
      <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[361px]">
                ...
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] py-[12px] relative size-full">
                    <div className="flex flex-[1_0_0] flex-col font-['Figtree:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-h-px min-w-px relative text-[#8e8e8e] text-[16px]">
                      <p className="leading-[24px]">Escreva sua pergunta</p>
                    </div>
                  </div>
                </div>
              </div>
