      ...
      >
        ...
        <div
          ...
          className={`absolute inset-0 pointer-events-none rounded-[12px] ${
            hasError
              ? ""
              : "focus-within:outline focus-within:outline-[3px] focus-within:outline-[#021b59] focus-within:outline-offset-[-1px]"
          }`}
        />
      </div>
      ...
      <div className="max-w-[900px] mx-auto flex flex-col gap-[16px] px-[20px] md:px-[40px] pt-[24px] w-full">
        ...
        <div className="flex flex-col w-full gap-[2px]">
          ...
          <div className="relative">
            ...
            >
              <span
                className={`flex-1 text-left font-['Figtree:Regular',sans-serif] font-normal text-[16px] ${
                  form.gender ? "text-[#333]" : "text-[#595959]"
                }`}
              >
              ...
              <div
                ...
                className={`absolute inset-0 pointer-events-none rounded-[12px] ${
                  showErrors && !!errors.gender
                    ? ""
                    : "focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-[#021b59] focus-visible:outline-offset-[-1px]"
                }`}
              />
            </button>
            {generoOpen && (
