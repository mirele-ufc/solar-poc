      ...
      <div className="max-w-[900px] mx-auto flex flex-col items-center gap-[28px] px-[20px] md:px-[40px] pt-[40px]">
        ...
        <div className="flex flex-col items-center gap-[8px] text-center">
          ...
          <p className="font-['Figtree:Regular',sans-serif] text-[#595959] text-[16px] leading-[25px] max-w-[480px]">
            Você acertou todas as questões da Prova 01 — Python Iniciante.
            Continue assim!
          </p>
        </div>
              ...
              <div className="flex flex-col gap-[6px]">
                {q.options.map((opt, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`flex items-center gap-[10px] py-[10px] px-[12px] rounded-[10px] border-2 ${isCorrect ? "bg-[#e8f8ee] border-[#28a745]" : "bg-white border-[#e0e0e0]"}`}
                    >
                      <div
                        className={`shrink-0 size-[20px] border-2 rounded-[4px] flex items-center justify-center ${isCorrect ? "bg-[#28a745] border-[#28a745]" : "bg-white border-[#ccc]"}`}
                      >
...
export function PythonExamResultPage() {
