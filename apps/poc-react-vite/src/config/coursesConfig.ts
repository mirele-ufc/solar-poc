 ...
 * Mapeia courseId para metadados do curso, incluindo questões de prova
 */
...
export interface CourseConfig {
  ...
  bullets: string[];
  heroImageUrl: string;
  enrollmentKey: string; // chave usada no Zustand store
...
/**
 * Helper: obter configuração do curso por ID
 */
...
/**
 * Helper: validar se courseId é válido
 */
...
/**
 * Helper: obter todos os IDs de cursos disponíveis
 */
