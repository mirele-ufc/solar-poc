  ...
  <div class="bg-white flex flex-col pb-[100px]">
    <div ref="topRef">
      ...
      >
        ...
        <p
          class="font-['Figtree:Medium',sans-serif] font-medium text-[#155724] text-[15px]"
        >
    ...
    <div
      class="max-w-[900px] mx-auto flex flex-col gap-[16px] px-[20px] md:px-[40px] pt-[24px] w-full text-left"
    >
      <PageHeader
        title="Inscrição"
      ...
      <h2
        class="font-['Figtree:Bold',sans-serif] font-bold leading-[36px] text-black text-[22px]"
      >
        Python Iniciante
      </h2>
      <p
        class="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] text-black text-[20px]"
      >
        Confirme seus dados
      </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-[16px]">
        <div class="flex flex-col w-full gap-[2px]">
          ...
          <div
            :class="[
              'bg-white h-[60px] w-full rounded-[12px] relative border transition-all',
              showErrors && !nome.trim()
                ? 'border-2 border-[#c0392b]'
                : 'border border-[#5f5f5f] focus-within:outline focus-within:outline-[3px] focus-within:outline-[#042e99] focus-within:outline-offset-[-1px]',
            ]"
          >
            <div class="flex items-center px-[20px] h-full">
              <input
                ...
                class="flex-1 font-['Figtree:Regular',sans-serif] font-normal text-[16px] text-[#333] placeholder-[#595959] bg-transparent outline-none"
              />
            </div>
          </div>
          <p
            v-if="showErrors && !nome.trim()"
            class="font-['Figtree:Regular',sans-serif] font-normal text-[14px] mt-[4px] text-[#c0392b]"
          >
            Nome não informado
          </p>
        </div>
        ...
        <div class="flex flex-col w-full gap-[2px]">
          ...
          <p
            v-if="showErrors && !sobrenome.trim()"
            class="font-['Figtree:Regular',sans-serif] font-normal text-[14px] mt-[4px] text-[#c0392b]"
          >
      ...
      <div class="flex flex-col w-full gap-[2px]">
        ...
        <div class="relative">
          <button
            ...
            :class="[
              'bg-white h-[60px] w-full rounded-[12px] flex items-center gap-[10px] px-[20px] py-[12px] relative transition-all border outline-none',
              showErrors && !genero
                ? 'border-2 border-[#c0392b]'
                : 'border border-[#5f5f5f] focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-[#042e99] focus-visible:outline-offset-[-1px]',
            ]"
          >
            <span
              :class="[
                'flex-1 text-left font-[\'Figtree:Regular\',sans-serif] font-normal text-[16px]',
          ...
          <div v-if="generoOpen">
            ...
            <ul
              role="listbox"
              aria-label="Gênero"
              class="absolute left-0 right-0 top-[65px] bg-white border border-[#5f5f5f] z-30 shadow-lg overflow-hidden rounded-[12px]"
            >
      ...
      <p
        class="font-['Figtree:Medium',sans-serif] font-medium leading-[30px] text-[#595959] text-[16px]"
      >
