<template>
  <main class="bg-gradient-to-b from-[#021b59] to-[#042e99] flex flex-col items-center p-[20px] min-h-screen">
    <div class="w-full max-w-[480px] mx-auto flex flex-col gap-[20px] items-center flex-1">
      ...
      <div class="inline-grid leading-[0] place-items-start relative shrink-0 mt-[10px]" aria-label="Logos da UFC">
      ...
      <form class="flex flex-col gap-[12px] items-start w-full" novalidate @submit.prevent="handleSubmit" aria-label="Formulário de login">
        ...
        <div class="flex flex-col gap-[16px] w-full mt-[8px]">
          ...
          >
            <span class="font-['Figtree:Medium',sans-serif] font-medium text-[#333] text-[20px]">Acessar</span>
          </button>
          <button
            type="button"
          ...
          >
            <span class="font-['Figtree:Medium',sans-serif] font-medium text-[#ffeac4] text-[20px]">Cadastrar</span>
          </button>
        </div>
      </form>
