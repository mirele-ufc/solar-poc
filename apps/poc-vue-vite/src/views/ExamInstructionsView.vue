...
// Proteção de rota para garantir matrícula antes de acessar as instruções
useEnrollmentGuard(courseId);

/**
 * Navega para a tela de execução da prova
 */
...
<template>
  <div class="flex flex-col min-h-[calc(100vh-70px)] pb-[120px] bg-[#ffffff]">
    <div
      class="max-w-[900px] mx-auto flex flex-col gap-[28px] px-[20px] md:px-[40px] pt-[30px] w-full"
    >
      <PageHeader
        title="Instruções"
      ...
      <h2
        class="font-['Anek_Devanagari:ExtraBold',sans-serif] font-extrabold text-[#021b59] text-[32px] md:text-[40px] leading-tight"
      >
        Prova 01
      </h2>

      <div class="bg-white rounded-[12px] p-[24px] md:p-[32px] shadow-sm">
        <h3
          class="font-['Figtree:Bold',sans-serif] font-bold text-[#021b59] text-[20px] mb-[16px]"
        >
          Instruções
        </h3>
        ...
        >
          <ul class="list-disc mb-0 space-y-[8px]">
            <li class="ms-[24px]">
              A prova tem {{ courseConfig.examQuestions.length }} questões;
            </li>
            <li class="ms-[24px]">O tempo total é de 60 minutos;</li>
            <li class="ms-[24px]">O cronômetro começa ao acessar a prova;</li>
            <li class="ms-[24px]">As respostas são salvas automaticamente;</li>
            <li class="ms-[24px]">
              Ao acabar o tempo, a prova é encerrada automaticamente e suas
              respostas ficam registradas.
            </li>
            <li class="ms-[24px]">Você terá apenas 1 tentativa.</li>
          </ul>

          <p
            class="mt-[24px] font-['Figtree:Medium',sans-serif] font-medium text-[#021b59]"
          >
            Boa prova!
          </p>
        </div>
