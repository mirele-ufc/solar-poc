...
const handleNext = async () => {
  ...
  try {
    const response = await courseService.createCourse(form.value, imageFile.value);
    ...
    error.value = err.message || "Erro ao conectar com o servidor. Tente novamente.";
    window.scrollTo({ top: 0, behavior: "smooth" });
  } finally {
  ...
  <div class="bg-white flex flex-col pb-[100px]">
    ...
    >
      ...
      <template v-else>
        ...
        <p class="text-white text-[14px] mt-[8px] font-['Figtree:Medium',sans-serif] font-medium">
          ...
          >
            ...
            >
              <svg
                ...
                aria-hidden="true"
              >
                <path stroke-linecap="round" stroke-linejoin="round" :d="checkPath" />
              </svg>
            </div>
      ...
      <div class="w-full max-w-[900px]">
        <button
          ...
          :class="[
            ...
            isSubmitting ? 'opacity-60 cursor-not-allowed' : 'hover:bg-[#ffd9a0]'
          ]"
        >
